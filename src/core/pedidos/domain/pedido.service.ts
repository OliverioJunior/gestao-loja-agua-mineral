...
export class PedidoService {
  ...
  async create(data: CreatePedidoInput): Promise<TPedido> {
    try {
      PedidoValidation.validateCreateInput(data);
  ...
  async update(id: string, data: UpdatePedidoInput): Promise<TPedido> {
    try {
      PedidoValidation.validateId(id);
      PedidoValidation.validateUpdateInput(data);
  ...
  async updateStatus(
    ...
    try {
      PedidoValidation.validateId(id);
      PedidoValidation.validateStatus(status);
      ...
      PedidoValidation.validateStatusTransition(existingPedido.status, status);
  ...
  async validateTotalConsistency(pedidoId: string): Promise<boolean> {
    try {
      ...
      PedidoValidation.validateTotalVsItens(pedido.total, totalItens);
