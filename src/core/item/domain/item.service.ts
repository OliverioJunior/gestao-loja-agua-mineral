...
import { ProdutoService } from "../../produto/domain/produto.service";
import { ProdutoRepository } from "../../produto/domain/produto.repository";
...
export class ItemService {
  ...
  async create(data: CreateItemInput): Promise<TItem> {
    try {
      ItemValidation.validateCreateInput(data);
      // Criar o item
  ...
  async update(id: string, data: UpdateItemInput): Promise<TItem> {
    try {
      ItemValidation.validateId(id);
      ItemValidation.validateUpdateInput(data);
  ...
  private async validateStockAvailability(
    ...
    ItemValidation.validateQuantidadeVsEstoque(quantidade, produto.estoque);
  }
  ...
  private async validateItemPrice(
    ...
    ItemValidation.validatePrecoVsProduto(precoItem, produto.precoVenda);
  }
