    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Adicione um item à compra, especificando o produto, quantidade,
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData((prev) => ({ ...prev, compraId: value }))
                }
                disabled={!!compraId}
              >
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="compra-1">
                    Compra #001 - Fornecedor A
                  </SelectItem>
                  <SelectItem value="compra-2">
                    Compra #002 - Fornecedor B
                  </SelectItem>
                </SelectContent>
              </Select>
              {errors.compraId && (
          ...
          <div className="bg-muted/50 p-4 rounded-lg">
            ...
            <div className="space-y-1 text-sm">
              <div className="flex justify-between">
                <span>
                  Subtotal ({formData.quantidade} × R${" "}
                  {formData.precoUnitario.toFixed(2)}):
                </span>
                <span className="font-mono">
                  {ItemCompraUtils.formatCurrency(
                    ItemCompraUtils.toCents(
