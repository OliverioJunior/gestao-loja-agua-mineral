      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Ferramentas de manutenção do PWA
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            ...
            <div className="text-xs text-muted-foreground mt-4">
              <p><strong>Limpar Cache:</strong> Remove dados armazenados localmente</p>
              <p><strong>Atualizar SW:</strong> Força atualização do Service Worker</p>
            </div>
          </CardContent>
        </Card>
