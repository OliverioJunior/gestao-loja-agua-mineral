...
import { UpdatePedidoInput } from "@/core/pedidos/domain";
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (body.desconto !== undefined)
      updateData.desconto = Number(body.desconto);
    if (body.taxaEntrega !== undefined)
      updateData.taxaEntrega = Number(body.taxaEntrega);
